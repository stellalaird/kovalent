...
const MOCK_USERS = [
  {
    ...
    tokens: 24, taught: 3, learned: 5, collabs: 4, rating: 4.8,
    contact: "priya@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 18, taught: 5, learned: 2, collabs: 7, rating: 4.6,
    contact: "marcus@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 31, taught: 7, learned: 3, collabs: 9, rating: 5.0,
    contact: "sofia@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 8, taught: 1, learned: 6, collabs: 2, rating: 4.0,
    contact: "jalen@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 22, taught: 4, learned: 4, collabs: 5, rating: 4.7,
    contact: "mei@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 15, taught: 2, learned: 7, collabs: 3, rating: 4.3,
    contact: "devon@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 11, taught: 1, learned: 5, collabs: 3, rating: 3.9,
    contact: "zchen@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 19, taught: 3, learned: 4, collabs: 8, rating: 4.5,
    contact: "mthompson@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 6, taught: 0, learned: 4, collabs: 2,
    contact: "amara@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 27, taught: 6, learned: 2, collabs: 4, rating: 4.9,
    contact: "luca@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 13, taught: 2, learned: 5, collabs: 6, rating: 4.2,
    contact: "nadia@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 33, taught: 8, learned: 3, collabs: 5, rating: 4.8,
    contact: "eli@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 20, taught: 4, learned: 6, collabs: 7, rating: 4.6,
    contact: "camille@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 5, taught: 0, learned: 3, collabs: 1,
    contact: "oliver@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 17, taught: 3, learned: 4, collabs: 9, rating: 4.4,
    contact: "simone@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 14, taught: 2, learned: 5, collabs: 4, rating: 4.1,
    contact: "aiden@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 29, taught: 5, learned: 3, collabs: 6, rating: 4.7,
    contact: "fatima@northwestern.edu", phone: "(000) 000-0000",
  ...
  },
  {
    ...
    tokens: 10, taught: 1, learned: 6, collabs: 3, rating: 3.8,
    contact: "theo@northwestern.edu", phone: "(000) 000-0000",
...
const MOCK_SESSIONS = [
  ...
  },
  {
    ...
    scheduledTime: "Thursday, June 12 · 6:00 PM",
    location: "Tech LG52",
  ...
  },
  {
    ...
    pastSessions: [
      ...
      { id: "ps-s8-2", scheduledTime: "Saturday, May 17 · 2:00 PM", location: "Norris Game Room", attendees: [MOCK_USERS[0], MOCK_USERS[4], MOCK_USERS[7], MOCK_USERS[11]], groupPhoto: "https://picsum.photos/seed/chess88/400/220" },
      { id: "ps-s8-3", scheduledTime: "Saturday, May 3 · 2:00 PM",  location: "Norris Game Room", attendees: [MOCK_USERS[0], MOCK_USERS[1], MOCK_USERS[7]], groupPhoto: "https://picsum.photos/seed/chess99/400/220" },
    ],
  },
  {
    ...
    messages: [],
    pastSessions: [
      { id: "ps-s9-1", scheduledTime: "Thursday, May 29 · 7:00 AM", location: "Lakefront Trail, Foster Beach start", attendees: [MOCK_USERS[2], MOCK_USERS[4], MOCK_USERS[8], MOCK_USERS[15]], groupPhoto: "https://picsum.photos/seed/run11/400/220" },
      { id: "ps-s9-2", scheduledTime: "Tuesday, May 27 · 7:00 AM", location: "Lakefront Trail, Foster Beach start", attendees: [MOCK_USERS[2], MOCK_USERS[8], MOCK_USERS[15]], groupPhoto: "https://picsum.photos/seed/run22/400/220" },
      { id: "ps-s9-3", scheduledTime: "Thursday, May 22 · 7:00 AM", location: "Lakefront Trail, Foster Beach start", attendees: [MOCK_USERS[4], MOCK_USERS[8]], groupPhoto: "https://picsum.photos/seed/run33/400/220" },
  ...
  },
  {
    ...
    pastSessions: [
      ...
      { id: "ps-s20-2", scheduledTime: "Sunday, April 27 · 10:00 AM", location: "Lakefront near SPAC",  attendees: [MOCK_USERS[2], MOCK_USERS[5]], groupPhoto: "https://picsum.photos/seed/photo44/400/220" },
    ],
    proposals: [
  ...
  // ── Completed sessions (not attended by current user) ───────
  {
    id: "ext-comp1", type: "learn", skill: "Jazz Guitar Workshop", teacher: MOCK_USERS[1],
    level: "Intermediate", status: "completed",
    scheduledTime: "May 22, 2025 · 6:00 PM", location: "Norris Music Room 208",
    tags: ["music", "guitar"],
    participants: [MOCK_USERS[9], MOCK_USERS[0], MOCK_USERS[17]],
    attended:     [MOCK_USERS[9], MOCK_USERS[0], MOCK_USERS[17]],
    groupPhoto: "https://picsum.photos/seed/jazzguitar1/400/220",
    description: "Advanced chord voicings and improv over ii–V–I progressions.",
    interested: 3, minGroup: 2, maxGroup: 6, activityLevel: "medium", messages: [],
  },
  {
    id: "ext-comp2", type: "learn", skill: "Acrylic Painting", teacher: MOCK_USERS[2],
    level: "All Levels", status: "completed",
    scheduledTime: "May 25, 2025 · 2:00 PM", location: "Kresge Hall, Room 2-410",
    tags: ["art", "creative"],
    participants: [MOCK_USERS[5], MOCK_USERS[14], MOCK_USERS[7]],
    attended:     [MOCK_USERS[5], MOCK_USERS[14], MOCK_USERS[7]],
    groupPhoto: "https://picsum.photos/seed/acrylic22/400/220",
    description: "Covered color mixing, layering, and basic composition techniques.",
    interested: 4, minGroup: 2, maxGroup: 8, activityLevel: "medium", messages: [],
  },
  {
    id: "ext-comp3", type: "learn", skill: "Conversational Spanish", teacher: MOCK_USERS[12],
    level: "Intermediate", status: "completed",
    scheduledTime: "May 18, 2025 · 5:00 PM", location: "Kresge Hall, Room 1-320",
    tags: ["language"],
    participants: [MOCK_USERS[3], MOCK_USERS[10], MOCK_USERS[8]],
    attended:     [MOCK_USERS[3], MOCK_USERS[10], MOCK_USERS[8]],
    groupPhoto: "https://picsum.photos/seed/spanish18/400/220",
    description: "Practice session focused on medical vocabulary and everyday conversation.",
    interested: 4, minGroup: 2, maxGroup: 6, activityLevel: "medium", messages: [],
  },
  {
    id: "ext-comp4", type: "learn", skill: "React & TypeScript", teacher: MOCK_USERS[11],
    level: "Intermediate", status: "completed",
    scheduledTime: "May 14, 2025 · 7:00 PM", location: "Tech LG52",
    tags: ["coding", "tech"],
    participants: [MOCK_USERS[7], MOCK_USERS[16], MOCK_USERS[13]],
    attended:     [MOCK_USERS[7], MOCK_USERS[16], MOCK_USERS[13]],
    groupPhoto: "https://picsum.photos/seed/reactts14/400/220",
    description: "Built a small app using React with TypeScript — components, types, and hooks.",
    interested: 4, minGroup: 2, maxGroup: 8, activityLevel: "high", messages: [],
  },
  {
    id: "ext-comp5", type: "collab", activity: "Photography Walk",
    status: "completed",
    tags: ["photography", "art"],
    scheduledTime: "April 20, 2025 · 10:00 AM", location: "Deering Library steps",
    participants: [MOCK_USERS[2], MOCK_USERS[5], MOCK_USERS[7], MOCK_USERS[16]],
    attended:     [MOCK_USERS[2], MOCK_USERS[5], MOCK_USERS[7], MOCK_USERS[16]],
    groupPhoto: "https://picsum.photos/seed/photowalk20/400/220",
    description: "Spring campus walk — golden hour portraits and architecture shots.",
